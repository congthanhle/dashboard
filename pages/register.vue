        ...
        <div class="w-full md:max-w-[550px] max-w-[360px] mx-auto">
          <div class="mt-10">
            ...
            <VeeForm :validation-schema="schema" as="div">
              <form class="mt-12" @submit="handleRegisterSubmit">
                <div class="mt-8">
                ...
                <div class="mt-10">
                  <button type="submit" class="bg-[#1bd760] hover:bg-green-600 rounded-full w-full p-3 text-white font-bold py-2 px-4 rounded">
                    Create account
                  </button>
                </div>
              </form>
